...
BA.2.12.1 still makes up a good share in North America but getting replaced bz BA.4/5. It's also present with smaller share around the world where BA.4/5 also replaces.
...
BA.2.75 seems able to compete with BA.5 in India. It was introduced later (first sequence end of May) and seems to range between 10-50% depending on state at beginning of July.

BA.2.75 has 8 Spike differences to BA.2 as opposed to BA.4/5, making BA.2.75 the most diverged Omicron variant with significant circulation to appear since BA.1/BA.2/BA.3.
